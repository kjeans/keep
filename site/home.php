...
require '../kshop/include.php';
	...
	//$regel4 = notequeries::queryHerinneringNotes('notes.datetime DESC'); // nieuwste herinnering notes
	//$regel5 = notequeries::queryArchivedNotes('notes.datetime DESC'); // nieuwste herinnering notes
	//$regel6 = notequeries::queryFavoriteNotes('notes.datetime DESC'); // nieuwste favoriete notes
