...
*/
		...
		//var_export($notedata);
			...
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s">Omschrijving:</th>', $notedata['color']);
			printf('<td class="o %s">%s</td>',$notedata['color'], form::textarea('omschrijving','', $notedata['description']));
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s>Prive of zakelijk:</th>');
			printf('<td class="o %s>%s</td>', form::selectbox('soort','', $notedata['type'], getTypes(true)));
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s>Archiveren:</th>');
			printf('<td class="o %s>%s</td>', form::checkbox('archiveren','', $notedata['archived']));
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s>Herinnering:</th>');
			printf('<td class="o %s>%s</td>', form::checkbox('herinnering','extrareminder', $notedata['reminder']));
			echo '</tr>';
			echo '<tr class="datum">';
			printf('<th class="o %s>Datum:</th>');
			printf('<td class="o %s>%s</td>', form::datebox('datum','', $notedata['date']));
			echo '</tr>';
			echo '<tr class="tijd">';
			printf('<th class="o %s>Tijd:</th>');
			printf('<td class="o %s>%s</td>', form::timebox('tijd','', $notedata['time']));
			echo '</tr>';
/*
			echo '<tr>';
...
*/
			echo '<tr>';
			printf('<th class="o %s>Tags:</th>');
			printf('<td class="o %s>%s</td>', form::textbox('keywords','', $notedata['tags']));
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s>Kleur:</th>');
			printf('<td class="o %s>%s</td>', form::kleurbox('kleur','', $notedata['color'], getColors(true)));
			echo '</tr>';
			echo '<tr>';
			printf('<th class="o %s>Foto:</th>');
			printf('<td class="o %s>%s</td>',self::getPicture($noteid));
			echo '</tr>';
			echo '<tr>';
			echo '<th class="o %s>&nbsp;</th>';
			printf('<td class="o %s><div class="formbutton">%s</div></td>', form::submit('Opslaan',''));
			echo '</tr>';
			echo '</table>';
