<?php
	...
	class Bladermenu {
		...
		public static function drawBladermenu() {
			...
			printf( '<li><span><a href="home.php?id=1">Archief</a></span></li>');
			printf( '<li><span><a href="home.php?id=4">Privé</a></span></li>');
			printf( '<li><span><a href="home.php?id=5">Zakelijk</a></span></li>');
